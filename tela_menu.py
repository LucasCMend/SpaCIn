...
class Menu:
    ...
    def __init__(self):
        ...
        self.background_image = pygame.image.load("Pasta_Menu/tela_fundo_menu.jpg")
        self.background_image = pygame.transform.scale(self.background_image, (750, 500))
    
        self.title_image = pygame.image.load("Pasta_Menu/title_card.png")
        self.title_hover_image = pygame.image.load("Pasta_Menu/title_card_hover.png")
        ...
        self.menu_image = pygame.image.load("Pasta_Menu/start.png")
        self.menu_image = pygame.transform.scale(self.menu_image, (200, 100))

        self.menu_hover = pygame.image.load("Pasta_Menu/start_hover.png")
